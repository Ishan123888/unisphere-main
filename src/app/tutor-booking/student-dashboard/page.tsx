...
const INITIAL_BOOKINGS = [
  {
    id: 'UNI-001', tutorName: 'Amal Perera', subject: 'Data Structures & Algorithms',
    slot: 'Mon 10:00 AM', date: 'Mar 24, 2026', duration: '2 Hours',
    sessionType: 'Online', amount: 3150, status: 'CONFIRMED', avatar: 'AP',
  },
  {
    id: 'UNI-002', tutorName: 'Dilki Jayawardena', subject: 'Database Management Systems',
    slot: 'Tue 3:00 PM', date: 'Mar 25, 2026', duration: '1 Hour',
    sessionType: 'Physical', amount: 1260, status: 'PENDING', avatar: 'DJ',
  },
  {
    id: 'UNI-003', tutorName: 'Tharaka Silva', subject: 'Web Technologies',
    slot: 'Fri 1:00 PM', date: 'Mar 21, 2026', duration: '2 Hours',
    sessionType: 'Online', amount: 4200, status: 'COMPLETED', avatar: 'TS',
  },
  {
    id: 'UNI-004', tutorName: 'Nethmi Rodrigo', subject: 'Computer Networks',
    slot: 'Wed 11:00 AM', date: 'Mar 20, 2026', duration: '1 Hour',
    sessionType: 'Physical', amount: 1155, status: 'CANCELLED', avatar: 'NR',
  },
];
...
export default function StudentDashboardPage() {
  ...
  const stats = {
    ...
    spent: bookings.filter(b => b.status !== 'CANCELLED').reduce((s, b) => s + b.amount, 0),
  };
              ...
              <div key={booking.id} className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100 hover:shadow-md transition-all">
                <div className="flex items-start gap-4">
                  ...
                  <div className="text-right flex-shrink-0">
                    <p className="font-black text-indigo-600 text-lg">Rs. {booking.amount.toLocaleString()}</p>

                    <div className="flex gap-2 mt-3 justify-end flex-wrap">
                      {booking.status === 'COMPLETED' && (
                        <button
                          onClick={() => router.push('/tutor-booking/rating-feedback')}
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 px-6">
          <div className="bg-white rounded-3xl p-8 max-w-sm w-full shadow-2xl">
            ...
            <p className="text-slate-400 text-sm font-medium text-center mb-6">
              This action cannot be undone. Cancellations within 2 hours of the session may incur a fee.
            </p>
